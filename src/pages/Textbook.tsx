...
const courseLessons: Record<string, { title: string; url: string }[]> = {
  ...
  html: [
    ...
    { title: "2. HTMLの役割と記述方法", url: "/course/html/lesson2" },
    { title: "3. HTMLの基本構造", url: "/course/html/lesson3" },
    { title: "4. 文章を構成する基本のタグ", url: "/course/html/lesson4" },
    { title: "5. その他のタグ", url: "/course/html/lesson5" },
    { title: "6. DOMツリーについて", url: "/course/html/lesson6" },
    { title: "7. セマンティックタグについて", url: "/course/html/lesson7" },
    { title: "8. 実践ハンズオン：自己紹介ページを作ろう", url: "/course/html/lesson8" },
    { title: "9. 応用：現場レベルの知識", url: "/course/html/lesson9" },
  ],
  js: [
    { title: "1. JavaScriptの役割と記述方法", url: "/course/js/lesson1" },
    { title: "2. 変数・データ型と基本構文", url: "/course/js/lesson2" },
    { title: "3. 配列・オブジェクトと繰り返し処理", url: "/course/js/lesson3" },
    { title: "4. 関数とスコープ（デバッグの基本）", url: "/course/js/lesson4" },
    { title: "5. DOM操作の基本", url: "/course/js/lesson5" },
    { title: "6. イベント処理", url: "/course/js/lesson6" },
    { title: "7. よく使うUIパターン", url: "/course/js/lesson7" },
    { title: "7. 非同期処理とAPI通信", url: "/course/js/lesson8" },
    { title: "7. 実践ハンズオン", url: "/course/js/lesson7" },
  ],
  design: [
  ...
  css: [
    { title: "1. CSSの役割と記述方法", url: "/course/css/lesson1" },
    { title: "2. 文字と色のスタイリング", url: "/course/css/lesson2" },
    { title: "3. Box Model", url: "/course/css/lesson3" },
    { title: "4. セレクタの活用と「詳細度」", url: "/course/css/lesson4" },
    { title: "5. レイアウト手法1（Flexbox）", url: "/course/css/lesson5" },
    { title: "6. レイアウト手法2（Positionと重ね合わせ）", url: "/course/css/lesson6" },
    { title: "7. レスポンシブデザインとメディアクエリ", url: "/course/css/lesson7" },
    { title: "8. 実践ハンズオン", url: "/course/css/lesson8" },
    { title: "9. 応用：現場レベルの知識", url: "/course/css/lesson9" },
  ],
  git: [
